...
2. Build image
    ...
    ```
    $ sudo docker build -t tachacoin-electrum-wine-builder-img contrib/build-wine
    ```
...
3. Build Windows binaries
    ...
    $ git checkout $REV
    $ sudo docker run -it \
        --name tachacoin-electrum-wine-builder-cont \
        -v $PWD:/opt/wine64/drive_c/electrum \
        --rm \
        --workdir /opt/wine64/drive_c/electrum/contrib/build-wine \
        tachacoin-electrum-wine-builder-img \
        ./build.sh
    ```
