...
def encode_fallback(fallback, currency):
    ...
    """
    if currency in [constants.TachacoinMainnet.SEGWIT_HRP, constants.TachacoinTestnet.SEGWIT_HRP]:
...
base58_prefix_map = {
    constants.TachacoinMainnet.SEGWIT_HRP : (constants.TachacoinMainnet.ADDRTYPE_P2PKH, constants.TachacoinMainnet.ADDRTYPE_P2SH),
    constants.TachacoinTestnet.SEGWIT_HRP : (constants.TachacoinTestnet.ADDRTYPE_P2PKH, constants.TachacoinTestnet.ADDRTYPE_P2SH)
}
